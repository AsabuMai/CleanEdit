...
#SBATCH -J t4t5-fix-s12
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/t4_t5_fix_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/t4_t5_fix_seed12_%j.err
...
echo "== T4/T5 fix validation: seed 12 =="
TASKS="$TASKS" \
