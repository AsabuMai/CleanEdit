...
OUT = PROJ / "outputs/fe118_repair_probe_metric_runs"
SRC = {
    "dece_rf_flux_repair": ("outputs/fe118_repair_probe_dece_flux", "dece_rf_flux"),
    "dece_rf_sd3_repair": ("outputs/fe118_repair_probe_dece_sd3", "support_v3_controller_rmsgap"),
}
...
for item in MAN:
    ...
    for method, (base, sub) in SRC.items():
        ...
        (run_dir / "command.txt").write_text(f"repair probe linked from {src}\n", encoding="utf-8")
        counts[method] += 1
