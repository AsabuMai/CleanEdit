...
#SBATCH -J src25-catbow
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_cat_bowtie_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_cat_bowtie_seed12_%j.err
...
echo "== source expansion cat red bow tie, CleanEdit seed12 =="
TASKS="$TASKS" \
...
task = "web_cat_red_bowtie"
result = Path("outputs/pretty_matrix") / task / "support_v3_controller_rmsgap" / "seed_12" / "result.png"
