...
#SBATCH -J src25-param12
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paramfix_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paramfix_seed12_%j.err
...
TASKS="web_woman_black_sunglasses web_cat_collar_bell web_mug_red_heart_decal web_gray_hoodie_quilted_panel web_white_shirt_lace_panel"
...
echo "== source expansion parameter-fix CleanEdit seed12 =="
TASKS="$TASKS" \
...
tasks = "web_woman_black_sunglasses web_cat_collar_bell web_mug_red_heart_decal web_gray_hoodie_quilted_panel web_white_shirt_lace_panel".split()
