...
#SBATCH -J src25-catbell
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_cat_bell_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_cat_bell_seed12_%j.err
...
echo "== source expansion cat collar bell, CleanEdit seed12 =="
TASKS="$TASKS" \
