...
Scope: Core-6 CleanEdit matrix with fixed per-task evaluation masks. This
...
| cat_crown | CleanEdit | 3 | 0.0542 | 0.1477 | 0.6504 | 0.9677 | 0.1018  0.0156 |
...
| dog_sunglasses | CleanEdit | 3 | 0.0488 | 0.1192 | 0.6236 | 0.9592 | 0.0842  0.2181 |
...
| mug_heart | CleanEdit | 3 | 0.0076 | 0.0728 | 0.9574 | 0.8114 | 0.0425  0.0000 |
...
| tshirt_star | CleanEdit | 3 | 0.0175 | 0.0657 | 0.8780 | 0.6217 | 0.0799  0.4941 |
...
| backpack_remove_toy_charm | CleanEdit | 3 | 0.0397 | 0.2201 | 0.7369 | 0.8845 | -0.0164  0.0000 |
...
| red_chair_blue | CleanEdit | 3 | 0.0591 | 0.2251 | 0.5220 | 0.8857 | 0.0065  0.8981 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cat_crown | Fixed CleanEdit displacement | 3 | 0.0540 | 0.1838 | 0.6503 | 0.9667 | 0.0921 |
| cat_crown | CleanEdit | 3 | 0.0542 | 0.1477 | 0.6504 | 0.9677 | 0.1018 |
| dog_sunglasses | Fixed CleanEdit displacement | 3 | 0.0487 | 0.1179 | 0.6227 | 0.9606 | 0.0896 |
| dog_sunglasses | CleanEdit | 3 | 0.0488 | 0.1192 | 0.6236 | 0.9592 | 0.0842 |
| mug_heart | Fixed CleanEdit displacement | 3 | 0.0077 | 0.0749 | 0.9573 | 0.8074 | 0.0420 |
| mug_heart | CleanEdit | 3 | 0.0076 | 0.0728 | 0.9574 | 0.8114 | 0.0425 |
| tshirt_star | Fixed CleanEdit displacement | 3 | 0.0175 | 0.0703 | 0.8773 | 0.6514 | 0.0772 |
| tshirt_star | CleanEdit | 3 | 0.0175 | 0.0657 | 0.8780 | 0.6217 | 0.0799 |
| backpack_remove_toy_charm | Fixed CleanEdit displacement | 3 | 0.0403 | 0.2234 | 0.7392 | 0.8689 | -0.0180 |
| backpack_remove_toy_charm | CleanEdit | 3 | 0.0397 | 0.2201 | 0.7369 | 0.8845 | -0.0164 |
| red_chair_blue | Fixed CleanEdit displacement | 3 | 0.0591 | 0.2241 | 0.5221 | 0.8896 | 0.0006 |
| red_chair_blue | CleanEdit | 3 | 0.0591 | 0.2251 | 0.5220 | 0.8857 | 0.0065 |
...
| CleanEdit | 18 | 4.33 | 3.83 | 4.17 | 1.83 | 4.17 |
...
| `cat_crown` | CleanEdit | 4.00 | 4.00 | 4.00 | 2.00 | 4.00 | Clear crown with source mostly preserved |
...
| `dog_sunglasses` | CleanEdit | 4.00 | 4.00 | 4.00 | 1.00 | 4.00 | Localized glasses with better source preservation |
...
| `mug_heart` | CleanEdit | 5.00 | 4.00 | 5.00 | 1.00 | 5.00 | Clean localized heart decal with strong preservation |
...
| `backpack_remove_toy_charm` | CleanEdit | 4.00 | 3.00 | 4.00 | 3.00 | 3.00 | Yellow dangling toy charm is removed and the upper cartoon patch is correctly retained; pink strap and metal hardware are mostly preserved, but the zipper/fabric behind the removed charm is locally smoothed and partially hallucinated. |
...
| `tshirt_star` | CleanEdit | 5.00 | 4.00 | 4.00 | 2.00 | 5.00 | Clearly visible red star on the chest with pose, jeans, background, and shirt structure mostly preserved |
...
| Task | Fixed edit score | CleanEdit edit score | Fixed outside L1 | CleanEdit outside L1 | Readout |
| --- | ---: | ---: | ---: | ---: | --- |
...
- CleanEdit is strongest on localized add/decal tasks: `cat_crown`,
...
- `dog_sunglasses` is a competitive accessory case: CleanEdit and generic support
  both score well, with CleanEdit showing lower artifact severity.
...
- `laptop_remove_sticker` is now reserved for a separate high-confidence
  completion-prior extension probe, not the base CleanEdit main table.
...
large standalone gains from feedback control over fixed CleanEdit displacement
...
1. Treat the internal Core-6 matrix as complete for the main CleanEdit evidence
...
3. Report `laptop_remove_sticker` as a high-confidence completion-prior
   ...
   replacement probe, not as base CleanEdit rows.
