...
| CleanEdit | 15 | 4.40 | 4.00 | 4.20 | 1.60 | 4.40 |
...
| `cat_crown` | CleanEdit | 4.00 | 4.00 | 4.00 | 2.00 | 4.00 | clear localized crown |
...
| `dog_sunglasses` | CleanEdit | 4.00 | 4.00 | 4.00 | 1.00 | 4.00 | localized glasses with strong preservation |
...
| `mug_heart` | CleanEdit | 5.00 | 4.00 | 5.00 | 1.00 | 5.00 | clean localized decal |
...
| `tshirt_star` | CleanEdit | 5.00 | 4.00 | 4.00 | 2.00 | 5.00 | clear red clothing decal with strong preservation |
...
| `backpack_remove_toy_charm` | CleanEdit | 4.00 | 4.00 | 4.00 | 2.00 | 4.00 | yellow charm removed; surrounding backpack, patch, strap, and hardware preserved |

## Interpretation

The core-5 visual audit strengthens the main edit-preserve story. CleanEdit has the highest overall mean after adding `tshirt_star`: it forms the requested red clothing decal while preserving pose, jeans, background, and most shirt structure. Direct target guidance remains the aggressive baseline but changes source composition and does not reliably form the medium star on `tshirt_star`. Generic support remains a strong preservation baseline, but it over-preserves and misses decal formation on `mug_heart` and `tshirt_star`.
