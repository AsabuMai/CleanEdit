# Normalized 512x512 Paper Assets

These files are display-only normalized copies for paper figures. Each image is resized to fit inside a 512x512 white canvas without stretching or cropping. Original experiment outputs and metrics are unchanged.
