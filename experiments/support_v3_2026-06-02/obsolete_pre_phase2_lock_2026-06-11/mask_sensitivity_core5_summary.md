...
| --- | --- | --- | --- | --- | --- |
| eroded | DeCE-RF-SD3 | 15 | 0.0404 | 0.1026 | 0.7094 |
...
| base | DeCE-RF-SD3 | 15 | 0.0393 | 0.0972 | 0.7094 |
...
| dilated | DeCE-RF-SD3 | 15 | 0.0388 | 0.0894 | 0.7094 |
...
Rankings:
- `eroded`: DeCE-RF-SD3 > Generic support > RF reconstruction > Direct target
- `base`: DeCE-RF-SD3 > Generic support > RF reconstruction > Direct target
- `dilated`: DeCE-RF-SD3 > Generic support > RF reconstruction > Direct target
