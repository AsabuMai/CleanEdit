...
#SBATCH -J src25-t1v5
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paramfix_t1_v5_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paramfix_t1_v5_seed12_%j.err
