...
#SBATCH -J src25-t3-noref12
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_t3_noref_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_t3_noref_seed12_%j.err
...
TASKS="${TASKS:-web_notebook_heart_sticker}"
SEEDS="${SEEDS:-12}"
