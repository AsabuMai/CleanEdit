...
OUT=PROJ/"outputs/pie_pilot_20260618"; SEED="10"
...
for e in man:
    ...
    cmd=[PY,str(PROJ/"scripts/run_dece_image.py"),
      ...
      "--support-mask",e["mask"],"--support-control-mode","fixed","--support-external-mask-role","attention",
      ...
      "--use-flux-attention-support",
      "--extra-arg=--true-cfg","--extra-arg=--distilled-guidance 1.0"]
    print("RUN",e["key"],e["family"]); sys.stdout.flush()
