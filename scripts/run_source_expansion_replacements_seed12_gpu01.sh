...
#SBATCH -J src25-repl
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_replacements_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_replacements_seed12_%j.err
...
TASKS="web_cat_sunglasses web_tshirt_yellow_oval_decal"
...
echo "== source expansion replacement tasks, CleanEdit seed12 =="
TASKS="$TASKS" \
...
tasks = "web_cat_sunglasses web_tshirt_yellow_oval_decal".split()
