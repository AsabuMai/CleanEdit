...
OUT=PROJ/os.environ.get("SD3_OUT","outputs/pie_auto_sd3_20260618"); SEED="10"
done=0
for e in man:
    ...
    cmd=[PY,str(PROJ/"run_edit_sd3.py"),
      ...
      "--object-mask-provider","attention_velocity","--grounding-method","none",
    ...
    print("RUN-SD3auto",e["key"]); sys.stdout.flush()
