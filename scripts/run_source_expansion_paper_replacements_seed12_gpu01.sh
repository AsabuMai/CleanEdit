...
#SBATCH -J src25-paper
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paper_replacements_seed12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/source_expansion_paper_replacements_seed12_%j.err
...
TASKS="web_woman_black_sunglasses web_mug_red_heart_decal web_gray_hoodie_quilted_panel"
...
echo "== source expansion paper-quality replacements, CleanEdit seed12 =="
TASKS="$TASKS" \
...
tasks = "web_woman_black_sunglasses web_mug_red_heart_decal web_gray_hoodie_quilted_panel".split()
