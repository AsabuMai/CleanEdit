...
task_config() {
  ...
  case "${task_id}" in
    ...
    P7|backpack_remove_toy_charm)
      ...
      ;;
    *)
      echo "Unknown TASK '${task_id}'. Valid Core-6 tasks: cat_crown bowl_apple_inside tshirt_star red_chair_blue pillow_same_color_cable_knit pillow_same_color_cable_knit_grey pillow_same_color_cable_knit_armchair backpack_remove_toy_charm. Additional T5 candidates: pillow_same_color_corduroy_panel pillow_same_color_linen_panel pillow_same_color_terry_panel. Diagnostic legacy T5: pillow_vertical_fabric_strip." >&2
      exit 2
      ;;
  esac
}
