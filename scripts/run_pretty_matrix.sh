...
task_config() {
  ...
  SUPPORT_FRONT_GLASSES_LENS_Y_FRAC=""
  SUPPORT_FRONT_GLASSES_HALF_EYE_SPAN_FRAC=""
  SUPPORT_PRESET=""
  ...
  TASK_GLASSES_LUMA_PRESERVE=""
  TASK_GLASSES_GRADIENT_PRESERVE=""
  TASK_GLASSES_DARKNESS_GUARD=""
  TASK_GLASSES_LENS_EXPAND_X=""
  TASK_GLASSES_LENS_EXPAND_Y=""
  TASK_GLASSES_MASK_BLUR=""
  TASK_GLASSES_FINAL_REF_COMPOSITE_SCALE=""
  TASK_GLASSES_FINAL_REF_COMPOSITE_BLUR=""
  TASK_GLASSES_HEDIT=""
  TASK_GLASSES_TEXT=""
  TASK_GLASSES_REC=""
  TASK_GLASSES_TRAJ=""
  ...
  TASK_METHOD_REC=""
  TASK_METHOD_TRAJ=""
  TASK_SUPPORT_TOP_PERCENTILE=""
  TASK_SUPPORT_MIN_AREA_RATIO=""
  TASK_SUPPORT_MAX_AREA_RATIO=""
  TASK_SUPPORT_KEEP_COMPONENTS=""
  TASK_SUPPORT_DILATE_RADIUS=""
  TASK_SUPPORT_BLUR_KERNEL=""
  TASK_EDIT_MASK_BOX=""
  TASK_EDIT_MASK_BOX_MODE=""
  TASK_LOCAL_TARGET_GUIDANCE_SCALE=""
  TASK_LOCAL_TARGET_CFG_SCALE=""
  TASK_OPFIELD_DECAL_HEDIT=""
  TASK_OPFIELD_DECAL_TEXT=""
  TASK_OPFIELD_DECAL_REC=""
  TASK_OPFIELD_DECAL_TRAJ=""
  SUPPORT_V3_OPFIELD_OBJECT_HEDIT=""
  SUPPORT_V3_OPFIELD_OBJECT_TEXT=""
  SUPPORT_V3_OPFIELD_OBJECT_ANCHOR=""
  SUPPORT_V3_OPFIELD_OBJECT_REGION=""
  DECAL_SHAPE=""
  DECAL_COLOR=""
  DECAL_BOX=""
  DECAL_SLANT_X="0.0"
  ...
  DECAL_MATERIAL_CONTRAST=""
  DECAL_MATERIAL_SCALE=""
  RECOLOR_TARGET_COLOR=""
  RECOLOR_SURFACE_NAME=""
  RECOLOR_BOX=""
  RECOLOR_SOURCE_COLOR=""
  RECOLOR_FILL_HOLES="1"
  RECOLOR_SOURCE_SUPPLEMENT_BOX=""
  RECOLOR_SOURCE_SUPPLEMENT_HUE_THRESHOLD=""
  RECOLOR_SOURCE_SUPPLEMENT_LAB_THRESHOLD=""
  RECOLOR_SOURCE_SUPPLEMENT_MASK_THRESHOLD=""
  RECOLOR_SOURCE_SUPPLEMENT_MIN_SATURATION=""
  RECOLOR_SOURCE_SUPPLEMENT_MIN_VALUE=""
  RECOLOR_SOURCE_SUPPLEMENT_MAX_VALUE=""
  RECOLOR_SOURCE_SUPPLEMENT_KEEP_COMPONENTS=""
  RECOLOR_SOURCE_SUPPLEMENT_MIN_AREA=""
  RECOLOR_SOURCE_SUPPLEMENT_OPEN_KERNEL=""
  RECOLOR_SOURCE_SUPPLEMENT_CLOSE_KERNEL=""
  ...
  case "${task_id}" in
    ...
    dog_front_sunglasses_phase2)
      ...
      ;;
    web_woman_black_sunglasses)
      TASK_NAME="web_woman_black_sunglasses"
      TASK_KIND="accessory_semantic_glasses"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_woman_black_sunglasses.jpg"
      SOURCE_PROMPT="A close-up portrait of a smiling woman indoors, with no glasses or accessory on her face."
      TARGET_PROMPT="A close-up portrait of the same smiling woman indoors, wearing black sunglasses aligned across both eyes, while preserving her hair, smile, shirt pattern, wall, lighting, and pose."
      ATTENTION_TARGET_WORDS="black,sunglasses,eyes,face"
      CHANGED_TARGET_WORDS="sunglasses"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="black sunglasses,sunglasses"
      SUPPORT_HOST_TOKENS="woman face,eyes,face"
      SUPPORT_V2_CANDIDATE="attention_x_clean"
      SUPPORT_V3_RELATION="on_face"
      SEMANTIC_PHRASE="woman face"
      SUPPORT_RELATION="inside"
      SUPPORT_SEMANTIC_RELATION="inside"
      SUPPORT_PRESET=""
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up portrait with black sunglasses aligned horizontally across both eyes of a smiling woman."
      EDIT_MASK_SHIFT_Y="${EDIT_MASK_SHIFT_Y:-0.035}"
      SUPPORT_V3_FACE_MIN_AREA_RATIO="${SUPPORT_V3_FACE_MIN_AREA_RATIO:-0.020}"
      SUPPORT_V3_FACE_MAX_AREA_RATIO="${SUPPORT_V3_FACE_MAX_AREA_RATIO:-0.130}"
      SUPPORT_V3_FACE_DILATE_RADIUS="${SUPPORT_V3_FACE_DILATE_RADIUS:-4}"
      SUPPORT_V3_FACE_BLUR_KERNEL="${SUPPORT_V3_FACE_BLUR_KERNEL:-3}"
    ...
    P5|tshirt_star)
      ...
      DECAL_OPACITY="0.92"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.14"
    ...
    pillow_white_chair_cable_knit)
      ...
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/pillow_white_chair.jpg"
      SOURCE_PROMPT="A photo of a plain white throw pillow on a pink upholstered chair in a room with a window, concrete wall, marble wall, and wooden floor."
      TARGET_PROMPT="A photo of the same plain white throw pillow on the same pink upholstered chair, with the entire pillow surface changed into same-color white chunky cable-knit fabric with thick braided knitted columns, while preserving the pillow shape, seams, shadows, chair, window, walls, floor, lighting, and the rest of the scene."
      ATTENTION_TARGET_WORDS="knit,cable,braided,pillow"
      CHANGED_TARGET_WORDS="knit,cable,braided"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="material_panel"
      ...
      DECAL_SHAPE="waffle_panel"
      DECAL_COLOR="128,128,128"
      DECAL_BOX="0.285,0.385,0.760,0.622"
      DECAL_SLANT_X="0.00"
      DECAL_PERSPECTIVE_Y="0.010"
      DECAL_EDGE_FEATHER_RADIUS="2.0"
      DECAL_TOP_FEATHER_FRAC="0.02"
    ...
    pillow_white_sofa_cluster_cable_knit)
      ...
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/pillow_white_sofa_cluster.jpg"
      SOURCE_PROMPT="A bright interior photo of a white sofa with several plain white throw pillows against a straw-textured wall and a black hanging chain."
      TARGET_PROMPT="A photo of the same white sofa with the same throw pillows, with only the front center white pillow changed into same-color white chunky cable-knit fabric with thick braided knitted columns, while preserving the surrounding pillows, sofa, straw wall, black chain, lighting, and the rest of the scene."
      ATTENTION_TARGET_WORDS="knit,cable,braided,pillow"
      CHANGED_TARGET_WORDS="knit,cable,braided"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="material_panel"
      SUPPORT_NEW_TOKENS="knit,cable,braided,material"
      SUPPORT_HOST_TOKENS="front center white pillow,pillow surface"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="front center white pillow"
      SUPPORT_RELATION="inside"
      DECAL_SHAPE="waffle_panel"
      DECAL_COLOR="128,128,128"
      DECAL_BOX="0.365,0.585,0.610,0.862"
      DECAL_SLANT_X="-0.02"
      DECAL_PERSPECTIVE_Y="0.018"
      DECAL_EDGE_FEATHER_RADIUS="2.0"
      DECAL_TOP_FEATHER_FRAC="0.02"
      DECAL_TOP_FEATHER_MIN_ALPHA="0.65"
      DECAL_OPACITY="1.0"
    ...
    bag_remove_decorative_tag_phase2)
      ...
      ;;
    web_dog_blue_bowtie)
      TASK_NAME="web_dog_blue_bowtie"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_dog_blue_bowtie.jpg"
      SOURCE_PROMPT="A photo of a fluffy dog sitting outdoors beside a wooden wall, with no accessory on its neck."
      TARGET_PROMPT="A photo of the same fluffy dog sitting outdoors beside the same wooden wall, wearing a small blue bow tie around its neck, while preserving the dog, pose, wall, grass, and background."
      ATTENTION_TARGET_WORDS="blue,bow,tie,neck,chest"
      CHANGED_TARGET_WORDS="bow,tie"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="bow,tie"
      SUPPORT_HOST_TOKENS="dog,neck,chest"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="below_host"
      SEMANTIC_PHRASE="dog"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a small blue bow tie attached at the front of a fluffy dog's neck."
      ;;
    web_dog_blue_collar)
      TASK_NAME="web_dog_blue_collar"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_dog_blue_collar.jpg"
      SOURCE_PROMPT="A photo of a fluffy dog sitting outdoors beside a wooden wall, with no collar or accessory on its neck."
      TARGET_PROMPT="A photo of the same fluffy dog sitting outdoors beside the same wooden wall, wearing a small blue collar around its neck, while preserving the dog, pose, wall, grass, railing, and background."
      ATTENTION_TARGET_WORDS="blue,collar,dog,neck"
      CHANGED_TARGET_WORDS="collar"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="blue collar,collar"
      SUPPORT_HOST_TOKENS="dog neck,dog"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="below_host"
      SEMANTIC_PHRASE="dog neck"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a small blue collar around the dog's neck."
      ;;
    web_rabbit_small_crown)
      TASK_NAME="web_rabbit_small_crown"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_rabbit_small_crown.jpg"
      SOURCE_PROMPT="A close-up portrait of a cute rabbit sitting on grass outdoors, with no accessory on its head."
      TARGET_PROMPT="A close-up portrait of the same cute rabbit sitting on the same grass outdoors, wearing a small bright golden crown clearly placed between its ears, while preserving the rabbit fur, pose, grass, and background."
      ATTENTION_TARGET_WORDS="golden,crown,ears,head,rabbit"
      CHANGED_TARGET_WORDS="crown"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="golden crown,crown"
      SUPPORT_HOST_TOKENS="rabbit ears,rabbit head,head"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="above_host"
      SEMANTIC_PHRASE="rabbit head"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a visible small bright golden crown centered between the rabbit's ears."
      ;;
    web_cat_sunglasses)
      TASK_NAME="web_cat_sunglasses"
      TASK_KIND="accessory_semantic_glasses"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_cat_sunglasses.jpg"
      SOURCE_PROMPT="A close-up portrait of a cat outdoors, with no accessory on its face."
      TARGET_PROMPT="A close-up portrait of the same cat outdoors, wearing small black sunglasses aligned across both eyes, while preserving the cat fur, ears, whiskers, body, garden background, and lighting."
      ATTENTION_TARGET_WORDS="sunglasses,eyes,cat"
      CHANGED_TARGET_WORDS="sunglasses"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="sunglasses"
      SUPPORT_HOST_TOKENS="cat head,cat eyes,eyes"
      SUPPORT_V2_CANDIDATE="attention_x_clean"
      SUPPORT_V3_RELATION="on_face"
      SEMANTIC_PHRASE="cat head"
      SUPPORT_RELATION="inside"
      SUPPORT_SEMANTIC_RELATION="inside"
      SUPPORT_PRESET=""
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of small black sunglasses aligned horizontally across both eyes of a cat."
      EDIT_MASK_SHIFT_Y="${EDIT_MASK_SHIFT_Y:-0.020}"
      SUPPORT_V3_FACE_MIN_AREA_RATIO="${SUPPORT_V3_FACE_MIN_AREA_RATIO:-0.020}"
      SUPPORT_V3_FACE_MAX_AREA_RATIO="${SUPPORT_V3_FACE_MAX_AREA_RATIO:-0.110}"
      SUPPORT_V3_FACE_DILATE_RADIUS="${SUPPORT_V3_FACE_DILATE_RADIUS:-2}"
      SUPPORT_V3_FACE_BLUR_KERNEL="${SUPPORT_V3_FACE_BLUR_KERNEL:-1}"
      SUPPORT_V3_FACE_HEDIT="${SUPPORT_V3_FACE_HEDIT:-0.76}"
      SUPPORT_V3_FACE_TEXT="${SUPPORT_V3_FACE_TEXT:-0.14}"
      SUPPORT_V3_FACE_REC_GUIDANCE_SCALE="${SUPPORT_V3_FACE_REC_GUIDANCE_SCALE:-0.18}"
      SUPPORT_V3_FACE_TRAJECTORY_PRESERVE_SCALE="${SUPPORT_V3_FACE_TRAJECTORY_PRESERVE_SCALE:-0.08}"
      ...
      ;;
    web_cat_red_bowtie)
      TASK_NAME="web_cat_red_bowtie"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_cat_red_bowtie.jpg"
      SOURCE_PROMPT="A close-up portrait of a cat outdoors, with no collar or accessory on its neck."
      TARGET_PROMPT="A close-up portrait of the same cat outdoors, wearing a small red bow tie attached below its chin at the front of the neck, while preserving the cat fur, ears, whiskers, body, garden background, brick wall, and lighting."
      ATTENTION_TARGET_WORDS="red,bow,tie,neck,chest,cat"
      CHANGED_TARGET_WORDS="bow,tie"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="red bow tie,bow,tie"
      SUPPORT_HOST_TOKENS="cat head,cat neck,chest"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="below_host"
      SEMANTIC_PHRASE="cat head"
      SUPPORT_RELATION="below"
      SUPPORT_SEMANTIC_RELATION="below"
      SUPPORT_SEMANTIC_EXPAND_X="0.35"
      SUPPORT_SEMANTIC_BAND_RATIO="0.42"
      SUPPORT_SEMANTIC_OVERLAP_RATIO="0.15"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a small red bow tie attached below the chin at the front of a cat's neck."
      SUPPORT_V3_OPFIELD_OBJECT_HEDIT="0.72"
      SUPPORT_V3_OPFIELD_OBJECT_TEXT="0.12"
      SUPPORT_V3_OPFIELD_OBJECT_ANCHOR="0.04"
      SUPPORT_V3_OPFIELD_OBJECT_REGION="0.04"
      ;;
    web_cat_red_collar)
      TASK_NAME="web_cat_red_collar"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_cat_red_collar.jpg"
      SOURCE_PROMPT="A close-up portrait of a cat outdoors, with no collar or accessory on its neck."
      TARGET_PROMPT="A close-up portrait of the same cat outdoors, wearing a clearly visible bright red collar band around the front of its neck, while preserving the cat fur, ears, whiskers, body, garden background, brick wall, and lighting."
      ATTENTION_TARGET_WORDS="red,collar,neck"
      CHANGED_TARGET_WORDS="collar"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_PRESET="localized_decal"
      SUPPORT_NEW_TOKENS="red collar,collar"
      SUPPORT_HOST_TOKENS="cat neck,cat head"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="below_host"
      SEMANTIC_PHRASE="cat head"
      SUPPORT_RELATION="below"
      SUPPORT_SEMANTIC_RELATION="below"
      SUPPORT_SEMANTIC_EXPAND_X="0.24"
      SUPPORT_SEMANTIC_BAND_RATIO="0.24"
      SUPPORT_SEMANTIC_OVERLAP_RATIO="0.18"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a clearly visible bright red collar band around the front of a cat's neck."
      DECAL_SHAPE="collar_band"
      DECAL_COLOR="red"
      DECAL_BOX="0.305,0.686,0.620,0.748"
      DECAL_SLANT_X="-0.07"
      DECAL_PERSPECTIVE_Y="0.035"
      DECAL_EDGE_FEATHER_RADIUS="1.60"
      DECAL_TOP_FEATHER_FRAC="0.22"
      DECAL_TOP_FEATHER_MIN_ALPHA="0.30"
      DECAL_OPACITY="0.82"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.62"
      TASK_DECAL_REF_LUMA_PRESERVE="0.50"
      ...
      SUPPORT_V3_OPFIELD_OBJECT_REGION="0.01"
      ;;
    web_cat_red_flower_ear)
      TASK_NAME="web_cat_red_flower_ear"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_cat_red_flower_ear.jpg"
      SOURCE_PROMPT="A close-up portrait of a cat outdoors, with no accessory near its ears."
      TARGET_PROMPT="A close-up portrait of the same cat outdoors, wearing a small red flower tucked beside one ear, while preserving the cat fur, eyes, whiskers, body, garden background, brick wall, and lighting."
      ATTENTION_TARGET_WORDS="red,flower,ear"
      CHANGED_TARGET_WORDS="flower"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_PRESET="localized_decal"
      SUPPORT_NEW_TOKENS="red flower,flower"
      SUPPORT_HOST_TOKENS="cat ear,cat head"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="on_face"
      SEMANTIC_PHRASE="cat head"
      SUPPORT_RELATION="inside"
      SUPPORT_SEMANTIC_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a small red flower tucked beside a cat's ear."
      DECAL_SHAPE="flower"
      DECAL_COLOR="red"
      DECAL_BOX="0.495,0.505,0.575,0.570"
      DECAL_SLANT_X="0.0"
      DECAL_PERSPECTIVE_Y="0.0"
      DECAL_EDGE_FEATHER_RADIUS="0.85"
      DECAL_TOP_FEATHER_FRAC="0.0"
      DECAL_TOP_FEATHER_MIN_ALPHA="0.0"
      DECAL_OPACITY="0.90"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.54"
      TASK_DECAL_REF_LUMA_PRESERVE="0.30"
      ...
      ;;
    web_cat_collar_bell)
      TASK_NAME="web_cat_collar_bell"
      TASK_KIND="accessory_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_cat_collar_bell.jpg"
      SOURCE_PROMPT="A close-up portrait of a cat outdoors, with no collar or bell on its neck."
      TARGET_PROMPT="A close-up portrait of the same cat outdoors, wearing a bright red leather collar with a clearly visible small shiny gold bell hanging just below the collar at the front of its neck, while preserving the cat fur texture, chest fur, ears, eyes, whiskers, body, garden background, brick wall, and lighting."
      ATTENTION_TARGET_WORDS="bright,red,leather,collar,gold,bell,neck"
      CHANGED_TARGET_WORDS="collar,bell"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="bright red leather collar,shiny gold bell,collar,bell"
      SUPPORT_HOST_TOKENS="cat neck,cat head"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="below_host"
      SEMANTIC_PHRASE="cat head"
      SUPPORT_RELATION="below"
      SUPPORT_SEMANTIC_RELATION="below"
      SUPPORT_SEMANTIC_EXPAND_X="0.16"
      SUPPORT_SEMANTIC_BAND_RATIO="0.22"
      SUPPORT_SEMANTIC_OVERLAP_RATIO="0.12"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a bright red leather cat collar with a clearly visible small shiny gold bell hanging naturally at the front of the neck, partially nestled in fur."
      TASK_SUPPORT_TOP_PERCENTILE="97"
      TASK_SUPPORT_MIN_AREA_RATIO="0.006"
      TASK_SUPPORT_MAX_AREA_RATIO="0.042"
      TASK_SUPPORT_DILATE_RADIUS="1"
      TASK_SUPPORT_BLUR_KERNEL="2"
      TASK_LOCAL_TARGET_GUIDANCE_SCALE="0.36"
      TASK_LOCAL_TARGET_CFG_SCALE="8.0"
      TASK_METHOD_HEDIT="0.78"
      TASK_METHOD_TEXT="0.14"
      TASK_METHOD_REC="0.26"
      TASK_METHOD_TRAJ="0.16"
      SUPPORT_V3_OPFIELD_OBJECT_HEDIT="0.78"
      SUPPORT_V3_OPFIELD_OBJECT_TEXT="0.14"
      SUPPORT_V3_OPFIELD_OBJECT_ANCHOR="0.02"
      SUPPORT_V3_OPFIELD_OBJECT_REGION="0.02"
      ;;
    web_plate_red_apple)
      TASK_NAME="web_plate_red_apple"
      TASK_KIND="object_in_container"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_plate_red_apple.jpg"
      SOURCE_PROMPT="A top-down photo of an empty white ceramic plate on a table setting, with no fruit on the plate."
      TARGET_PROMPT="A top-down photo of the same white ceramic plate in the same table setting, with one small red apple centered on the plate, while preserving the plate, utensils, table, and background."
      ATTENTION_TARGET_WORDS="apple,plate,center"
      CHANGED_TARGET_WORDS="apple"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="apple"
      SUPPORT_HOST_TOKENS="plate,white ceramic plate"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="inside_container"
      SEMANTIC_PHRASE="white ceramic plate"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up top-down photo of one small red apple centered on a white ceramic plate."
      ;;
    web_wicker_basket_apples)
      TASK_NAME="web_wicker_basket_apples"
      TASK_KIND="object_in_container"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_wicker_basket_apples.jpg"
      SOURCE_PROMPT="A close-up photo of an empty brown wicker basket on a table, with no fruit inside the basket."
      TARGET_PROMPT="A close-up photo of the same brown wicker basket on the same table, with several small red apples placed inside the basket, while preserving the basket weave, handles, table, and background."
      ATTENTION_TARGET_WORDS="apples,basket,inside"
      CHANGED_TARGET_WORDS="apples"
      SUPPORT_EDIT_OPERATION="add_object"
      SUPPORT_NEW_TOKENS="apples,red apples"
      SUPPORT_HOST_TOKENS="basket,wicker basket"
      SUPPORT_V2_CANDIDATE="new_plus_host_x_clean"
      SUPPORT_V3_RELATION="inside_container"
      SEMANTIC_PHRASE="wicker basket"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of several small red apples placed inside an empty brown wicker basket."
      ;;
    web_tshirt_smiley)
      TASK_NAME="web_tshirt_smiley"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_tshirt_smiley.jpg"
      SOURCE_PROMPT="A photo of a person wearing a plain white shirt, with no graphic on the shirt."
      TARGET_PROMPT="A photo of the same person wearing the same white shirt, with a small yellow star graphic naturally printed on the center of the shirt, following the fabric folds and lighting, while preserving the body pose and background."
      ATTENTION_TARGET_WORDS="yellow,star,graphic,shirt"
      CHANGED_TARGET_WORDS="star,graphic"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="localized_decal"
      SUPPORT_NEW_TOKENS="yellow star graphic,star,graphic"
      SUPPORT_HOST_TOKENS="white shirt,shirt"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="white shirt"
      SUPPORT_RELATION="inside"
      DECAL_SHAPE="printed_star"
      DECAL_COLOR="245,205,32"
      DECAL_BOX="0.525,0.425,0.650,0.575"
      DECAL_OPACITY="1.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.24"
      TASK_DECAL_REF_LUMA_PRESERVE="0.35"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.12"
      TASK_DECAL_REF_SMOOTH_KERNEL="1"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.0"
      TASK_LOCAL_TARGET_GUIDANCE_SCALE="0.25"
      TASK_LOCAL_TARGET_CFG_SCALE="8.0"
      TASK_METHOD_HEDIT="0.66"
      TASK_METHOD_TEXT="0.10"
      TASK_METHOD_REC="0.34"
      TASK_METHOD_TRAJ="0.22"
      ;;
    web_tshirt_yellow_oval_decal)
      TASK_NAME="web_tshirt_yellow_oval_decal"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_tshirt_yellow_oval_decal.jpg"
      SOURCE_PROMPT="A photo of a person wearing a plain white shirt, with no graphic on the shirt."
      TARGET_PROMPT="A photo of the same person wearing the same white shirt, with a small hard-edged yellow oval decal printed on the center of the shirt, while preserving the fabric folds, body pose, and background."
      ATTENTION_TARGET_WORDS="yellow,oval,decal,shirt"
      CHANGED_TARGET_WORDS="oval,decal"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="localized_decal"
      SUPPORT_NEW_TOKENS="oval,decal"
      SUPPORT_HOST_TOKENS="white shirt,shirt"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="white shirt"
      SUPPORT_RELATION="inside"
      ...
      DECAL_BOX="0.525,0.425,0.650,0.575"
      DECAL_OPACITY="1.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.36"
      TASK_DECAL_REF_LUMA_PRESERVE="0.04"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.02"
      TASK_DECAL_REF_SMOOTH_KERNEL="1"
      TASK_COMPLETION_CLEAN_DELTA_SCALE="1.10"
      TASK_COMPLETION_CLEAN_DELTA_SCHEDULE_START="0.0"
      TASK_COMPLETION_CLEAN_DELTA_SCHEDULE_STOP="0.0"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.72"
      ;;
    web_mug_red_heart_decal)
      TASK_NAME="web_mug_red_heart_decal"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_mug_red_heart_decal.jpg"
      SOURCE_PROMPT="A close-up photo of a plain white ceramic mug on a wooden table, with no graphic on the mug."
      TARGET_PROMPT="A close-up photo of the same white ceramic mug on the same wooden table, with a small red heart graphic naturally printed on the front ceramic surface, following the mug curvature and lighting, while preserving the handle, coffee surface, wooden table, lighting, and background."
      ATTENTION_TARGET_WORDS="red,heart,graphic,mug,front"
      CHANGED_TARGET_WORDS="heart,graphic"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_NEW_TOKENS="red heart graphic,heart,graphic"
      SUPPORT_HOST_TOKENS="white mug,mug"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="white mug"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of a white ceramic mug with a small red heart graphic printed on the front surface."
      TASK_OPFIELD_DECAL_HEDIT="0.70"
      TASK_OPFIELD_DECAL_TEXT="0.14"
      TASK_OPFIELD_DECAL_REC="0.22"
      TASK_OPFIELD_DECAL_TRAJ="0.12"
      ;;
    web_notebook_heart_sticker)
      TASK_NAME="web_notebook_heart_sticker"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_notebook_heart_sticker.jpg"
      SOURCE_PROMPT="A top-down photo of an open blank notebook on a soft yellow background, with no drawing on the page."
      TARGET_PROMPT="A top-down photo of the same open blank notebook on the same soft yellow background, with a small light-blue colored-pencil heart sketch drawn naturally on the right notebook page, following the page perspective and lighting, while preserving the notebook edges, page lines, and background."
      ATTENTION_TARGET_WORDS="blue,heart,pencil,sketch,notebook,page"
      CHANGED_TARGET_WORDS="heart,pencil,sketch"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="localized_decal"
      SUPPORT_NEW_TOKENS="blue colored-pencil heart sketch,heart,pencil sketch"
      SUPPORT_HOST_TOKENS="right notebook page,notebook page"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="right notebook page"
      SUPPORT_RELATION="inside"
      SUPPORT_LOCAL_TARGET_PROMPT="A top-down close-up photo of a small light-blue colored-pencil heart sketch drawn naturally on the right notebook page."
      TASK_SUPPORT_TOP_PERCENTILE="90"
      TASK_SUPPORT_MIN_AREA_RATIO="0.014"
      TASK_SUPPORT_MAX_AREA_RATIO="0.045"
      TASK_SUPPORT_DILATE_RADIUS="2"
      TASK_SUPPORT_BLUR_KERNEL="3"
      DECAL_SHAPE="heart"
      DECAL_COLOR="20,95,220"
      DECAL_BOX="0.475,0.355,0.565,0.455"
      DECAL_OPACITY="1.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.22"
      TASK_DECAL_REF_LUMA_PRESERVE="0.30"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.12"
      TASK_DECAL_REF_SMOOTH_KERNEL="1"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.0"
      ...
      TASK_OPFIELD_DECAL_TEXT="0.13"
      TASK_OPFIELD_DECAL_REC="0.28"
      TASK_OPFIELD_DECAL_TRAJ="0.18"
      ;;
    web_red_suitcase_to_blue)
      TASK_NAME="web_red_suitcase_to_blue"
      TASK_KIND="recolor_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_red_suitcase_to_blue.jpg"
      SOURCE_PROMPT="A close-up photo of a red suitcase on grass with a smartphone and passport placed on top."
      TARGET_PROMPT="A close-up photo of the same suitcase on the same grass with the same smartphone and passport placed on top, with only the suitcase shell color changed from red to saturated royal blue, while preserving the phone, passport, grass, shadows, and suitcase structure."
      ATTENTION_TARGET_WORDS="suitcase,blue"
      CHANGED_TARGET_WORDS="suitcase"
      SUPPORT_EDIT_OPERATION="recolor"
      SUPPORT_NEW_TOKENS="royal blue"
      SUPPORT_HOST_TOKENS="suitcase,red suitcase"
      SUPPORT_REMOVED_TOKENS="suitcase"
      SUPPORT_V3_RELATION="inside"
      SEMANTIC_PHRASE="red suitcase"
      SUPPORT_RELATION="inside"
      RECOLOR_TARGET_COLOR="20,105,225"
      RECOLOR_EDIT_COLOR_TARGET="blue"
      RECOLOR_SURFACE_NAME="suitcase"
      RECOLOR_SOURCE_COLOR="red"
      RECOLOR_SOURCE_MASK_THRESHOLD="0.14"
      RECOLOR_SOURCE_LAB_THRESHOLD="0.50"
      RECOLOR_SOURCE_CLOSE_KERNEL="9"
      RECOLOR_SOURCE_DILATE_KERNEL="7"
      RECOLOR_SOURCE_DILATE_ITERATIONS="1"
      RECOLOR_SOURCE_DILATE_MIN_SATURATION="0.10"
      RECOLOR_SOURCE_SUPPLEMENT_BOX="0.44,0.00,1.00,0.36;0.00,0.78,1.00,1.00"
      RECOLOR_SOURCE_SUPPLEMENT_HUE_THRESHOLD="0.25"
      RECOLOR_SOURCE_SUPPLEMENT_LAB_THRESHOLD="0.72"
      RECOLOR_SOURCE_SUPPLEMENT_MASK_THRESHOLD="0.08"
      RECOLOR_SOURCE_SUPPLEMENT_MIN_SATURATION="0.12"
      RECOLOR_SOURCE_SUPPLEMENT_MIN_VALUE="0.08"
      RECOLOR_SOURCE_SUPPLEMENT_MAX_VALUE="1.0"
      RECOLOR_SOURCE_SUPPLEMENT_KEEP_COMPONENTS="1"
      RECOLOR_SOURCE_SUPPLEMENT_CLOSE_KERNEL="9"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_KERNEL="5"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_ITERATIONS="1"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_MIN_SATURATION="0.06"
      RECOLOR_REF_BLEND="1.0"
      RECOLOR_REF_MASK_BLUR="1"
      RECOLOR_REF_GUIDANCE_SCALE="0.70"
      RECOLOR_COLOR_GUIDANCE_SCALE="0.18"
      RECOLOR_TARGET_CHROMA_SCALE="1.25"
      RECOLOR_LUMA_PRESERVE_SCALE="0.62"
      RECOLOR_REF_LUMA_PRESERVE_SCALE="0.62"
      RECOLOR_REF_GRADIENT_PRESERVE_SCALE="0.30"
      RECOLOR_CLEAN_PROJECTION_SCALE="0.70"
      RECOLOR_CLEAN_PROJECTION_MODE="yuv_texture"
      RECOLOR_CLEAN_PROJECTION_CHROMA_TEXTURE_SCALE="0.18"
      RECOLOR_CLEAN_PROJECTION_ALPHA_POWER="0.75"
      ...
      ;;
    web_orange_handbag_to_blue)
      TASK_NAME="web_orange_handbag_to_blue"
      TASK_KIND="recolor_semantic"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_orange_handbag_to_blue.jpg"
      SOURCE_PROMPT="A studio photo of a person holding a small orange leather handbag against a plain gray background."
      TARGET_PROMPT="A studio photo of the same person holding the same leather handbag against the same plain gray background, with only the handbag color, including the handle, changed from orange to saturated royal blue leather, while preserving the hand, sleeve, shadows, and background."
      ATTENTION_TARGET_WORDS="handbag,blue"
      CHANGED_TARGET_WORDS="handbag,body"
      SUPPORT_EDIT_OPERATION="recolor"
      SUPPORT_NEW_TOKENS="royal blue,leather"
      SUPPORT_HOST_TOKENS="handbag body,orange handbag,handbag"
      SUPPORT_REMOVED_TOKENS="handbag"
      SUPPORT_V3_RELATION="inside"
      SEMANTIC_PHRASE="orange handbag"
      SUPPORT_RELATION="inside"
      RECOLOR_TARGET_COLOR="20,105,225"
      RECOLOR_EDIT_COLOR_TARGET="blue"
      RECOLOR_SURFACE_NAME="handbag"
      RECOLOR_SOURCE_COLOR="orange"
      RECOLOR_SOURCE_MASK_THRESHOLD="0.10"
      RECOLOR_SOURCE_HUE_THRESHOLD="0.12"
      RECOLOR_SOURCE_LAB_THRESHOLD="0.58"
      RECOLOR_SOURCE_MIN_SATURATION="0.18"
      RECOLOR_SOURCE_MIN_VALUE="0.12"
      RECOLOR_SOURCE_CLOSE_KERNEL="5"
      RECOLOR_SOURCE_DILATE_KERNEL="3"
      RECOLOR_SOURCE_DILATE_ITERATIONS="1"
      RECOLOR_SOURCE_DILATE_MIN_SATURATION="0.08"
      RECOLOR_SOURCE_SUPPLEMENT_BOX="0.18,0.22,0.66,0.58"
      RECOLOR_SOURCE_SUPPLEMENT_HUE_THRESHOLD="0.22"
      RECOLOR_SOURCE_SUPPLEMENT_LAB_THRESHOLD="0.82"
      RECOLOR_SOURCE_SUPPLEMENT_MASK_THRESHOLD="0.05"
      RECOLOR_SOURCE_SUPPLEMENT_MIN_SATURATION="0.12"
      RECOLOR_SOURCE_SUPPLEMENT_MIN_VALUE="0.08"
      RECOLOR_SOURCE_SUPPLEMENT_MAX_VALUE="1.0"
      RECOLOR_SOURCE_SUPPLEMENT_KEEP_COMPONENTS="0"
      RECOLOR_SOURCE_SUPPLEMENT_CLOSE_KERNEL="7"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_KERNEL="3"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_ITERATIONS="1"
      RECOLOR_SOURCE_SUPPLEMENT_DILATE_MIN_SATURATION="0.06"
      RECOLOR_REF_BLEND="1.0"
      RECOLOR_REF_MASK_BLUR="1"
      RECOLOR_REF_GUIDANCE_SCALE="0.62"
      RECOLOR_COLOR_GUIDANCE_SCALE="0.16"
      RECOLOR_TARGET_CHROMA_SCALE="1.20"
      RECOLOR_LUMA_PRESERVE_SCALE="0.76"
      RECOLOR_REF_LUMA_PRESERVE_SCALE="0.76"
      RECOLOR_REF_GRADIENT_PRESERVE_SCALE="0.42"
      RECOLOR_CLEAN_PROJECTION_SCALE="0.62"
      RECOLOR_CLEAN_PROJECTION_MODE="yuv_texture"
      RECOLOR_CLEAN_PROJECTION_CHROMA_TEXTURE_SCALE="0.18"
      ...
      TASK_FINAL_REF_COMPOSITE_BLUR="0.0"
      ;;
    web_handheld_tote_woven_panel)
      TASK_NAME="web_handheld_tote_woven_panel"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_handheld_tote_woven_panel.jpg"
      SOURCE_PROMPT="A studio photo of a person holding a plain white tote bag against a neutral beige background, with a smooth flat bag front."
      TARGET_PROMPT="A studio photo of the same person holding the same white tote bag against the same neutral beige background, with only the front bag panel changed into same-color white waffle-knit material with visible raised woven cells, while preserving the hand, sleeve, handles, bag outline, and background."
      ATTENTION_TARGET_WORDS="waffle,knit,fabric,panel,tote,bag"
      CHANGED_TARGET_WORDS="waffle,knit,panel"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="material_panel"
      SUPPORT_NEW_TOKENS="waffle,knit,material"
      SUPPORT_HOST_TOKENS="white tote bag,bag front"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="white tote bag"
      SUPPORT_RELATION="inside"
      DECAL_SHAPE="waffle_panel"
      DECAL_COLOR="128,128,128"
      DECAL_BOX="0.370,0.365,0.560,0.720"
      DECAL_SLANT_X="-0.02"
      DECAL_PERSPECTIVE_Y="0.020"
      DECAL_EDGE_FEATHER_RADIUS="1.8"
      DECAL_OPACITY="1.0"
      DECAL_MATERIAL_CONTRAST="1.65"
      DECAL_MATERIAL_SCALE="0.56"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of same-color white tote bag fabric with visible raised waffle-knit cells on the front panel."
      TASK_LOCAL_TARGET_GUIDANCE_SCALE="0.22"
      TASK_LOCAL_TARGET_CFG_SCALE="8.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.26"
      TASK_DECAL_REF_LUMA_PRESERVE="0.34"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.08"
      TASK_OPFIELD_DECAL_HEDIT="0.72"
      TASK_OPFIELD_DECAL_TEXT="0.16"
      TASK_OPFIELD_DECAL_REC="0.36"
      TASK_OPFIELD_DECAL_TRAJ="0.22"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.42"
      TASK_FINAL_REF_COMPOSITE_BLUR="1.2"
      ;;
    web_gray_hoodie_quilted_panel)
      TASK_NAME="web_gray_hoodie_quilted_panel"
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_gray_hoodie_quilted_panel.jpg"
      SOURCE_PROMPT="A portrait photo of a woman wearing a plain smooth gray hoodie against a textured wall, with no pattern on the hoodie chest."
      TARGET_PROMPT="A portrait photo of the same woman wearing the same gray hoodie against the same textured wall, with the front chest fabric changed into realistic same-color gray woven waffle texture with visible fibers and soft recessed cells following the hoodie folds and lighting, while preserving her face, hair, hands, hood strings, pocket, wall, lighting, and pose."
      ATTENTION_TARGET_WORDS="gray,woven,waffle,texture,fibers,hoodie,chest"
      CHANGED_TARGET_WORDS="woven,waffle,texture,fibers"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="material_panel"
      SUPPORT_NEW_TOKENS="woven waffle texture,fabric fibers"
      SUPPORT_HOST_TOKENS="gray hoodie,hoodie"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="gray hoodie"
      SUPPORT_RELATION="inside"
      SUPPORT_CHROMA_GUARD="1"
      DECAL_SHAPE="real_waffle_panel"
      DECAL_COLOR="128,128,128"
      DECAL_BOX="0.335,0.370,0.665,0.755"
      DECAL_SLANT_X="0.00"
      DECAL_PERSPECTIVE_Y="0.010"
      DECAL_EDGE_FEATHER_RADIUS="2.0"
      DECAL_TOP_FEATHER_FRAC="0.02"
      DECAL_TOP_FEATHER_MIN_ALPHA="0.65"
      DECAL_OPACITY="1.0"
      DECAL_MATERIAL_CONTRAST="1.30"
      DECAL_MATERIAL_SCALE="0.44"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of realistic same-color gray woven waffle hoodie fabric with visible fibers and soft recessed cells."
      TASK_LOCAL_TARGET_GUIDANCE_SCALE="0.26"
      TASK_LOCAL_TARGET_CFG_SCALE="8.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.10"
      TASK_DECAL_REF_LUMA_PRESERVE="0.60"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.20"
      TASK_OPFIELD_DECAL_HEDIT="0.82"
      TASK_OPFIELD_DECAL_TEXT="0.20"
      TASK_OPFIELD_DECAL_REC="0.34"
      TASK_OPFIELD_DECAL_TRAJ="0.22"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.0"
      TASK_FINAL_REF_COMPOSITE_BLUR="1.2"
    ...
    web_white_shirt_lace_panel)
      ...
      TASK_KIND="decal"
      IMAGE="${ROOT}/data/source_expansion_25/sources/web_white_shirt_lace_panel.jpg"
      SOURCE_PROMPT="A close-up photo of a plain white shirt on a hanger held by a hand against a pale wall, with smooth shirt fabric."
      TARGET_PROMPT="A close-up photo of the same white shirt on the same hanger held by the same hand against the same pale wall, with the front shirt fabric changed into realistic same-color white woven waffle texture with visible fibers and soft recessed cells following the shirt folds and lighting, while preserving the hand, hanger, collar, buttons, wall, and shadows."
      ATTENTION_TARGET_WORDS="white,woven,waffle,texture,fibers,shirt"
      CHANGED_TARGET_WORDS="woven,waffle,texture,fibers"
      SUPPORT_EDIT_OPERATION="add_decal"
      SUPPORT_PRESET="material_panel"
      SUPPORT_NEW_TOKENS="woven waffle texture,fabric fibers"
      SUPPORT_HOST_TOKENS="white shirt,front shirt"
      SUPPORT_V3_RELATION="on_surface"
      SEMANTIC_PHRASE="white shirt"
      SUPPORT_RELATION="inside"
      SUPPORT_CHROMA_GUARD="1"
      DECAL_SHAPE="real_waffle_panel"
      DECAL_COLOR="128,128,128"
      DECAL_BOX="0.120,0.500,0.600,0.835"
      DECAL_SLANT_X="-0.02"
      DECAL_PERSPECTIVE_Y="0.020"
      DECAL_EDGE_FEATHER_RADIUS="2.0"
      DECAL_TOP_FEATHER_FRAC="0.02"
      DECAL_TOP_FEATHER_MIN_ALPHA="0.65"
      DECAL_OPACITY="1.0"
      DECAL_MATERIAL_CONTRAST="1.22"
      DECAL_MATERIAL_SCALE="0.46"
      SUPPORT_LOCAL_TARGET_PROMPT="A close-up photo of realistic same-color white woven waffle shirt fabric with visible fibers and soft recessed cells."
      TASK_LOCAL_TARGET_GUIDANCE_SCALE="0.24"
      TASK_LOCAL_TARGET_CFG_SCALE="8.0"
      TASK_DECAL_REF_GUIDANCE_SCALE="0.16"
      TASK_DECAL_REF_LUMA_PRESERVE="0.62"
      TASK_DECAL_REF_GRADIENT_PRESERVE="0.22"
      TASK_OPFIELD_DECAL_HEDIT="0.80"
      TASK_OPFIELD_DECAL_TEXT="0.18"
      TASK_OPFIELD_DECAL_REC="0.36"
      TASK_OPFIELD_DECAL_TRAJ="0.24"
      TASK_FINAL_REF_COMPOSITE_SCALE="0.0"
      TASK_FINAL_REF_COMPOSITE_BLUR="1.2"
      TASK_FINAL_CHROMA_SOURCE_SCALE="1.0"
      TASK_FINAL_CHROMA_SOURCE_BLUR="2.0"
...
method_config() {
  ...
  case "${method_id}" in
    ...
    M18|support_v3_controller_rmsgap|adaptive_full_support_v3_v0)
      ...
      METHOD_ROUTE="full"
      METHOD_ABLATION="none"
      EDIT_HEDIT_GUIDANCE_SCALE="${TASK_METHOD_HEDIT:-0.65}"
      EDIT_TEXT_GUIDANCE_SCALE="${TASK_METHOD_TEXT:-0.08}"
      REC_GUIDANCE_SCALE="${TASK_METHOD_REC:-0.22}"
      TRAJECTORY_PRESERVE_SCALE="${TASK_METHOD_TRAJ:-0.12}"
      ADAPTIVE_CLEAN_CONTROL="1"
      ADAPTIVE_EDIT_TARGET_PROGRESS="0.0"
      ADAPTIVE_EDIT_TARGET_RMS="0.42"
      GENERIC_SUPPORT="1"
...
ensure_semantic_mask() {
  ...
  if [[ -n "${SUPPORT_FRONT_GLASSES_LENS_Y_FRAC}" ]]; then
    cmd+=(--front-glasses-lens-y-frac "${SUPPORT_FRONT_GLASSES_LENS_Y_FRAC}")
  fi
  if [[ -n "${SUPPORT_FRONT_GLASSES_HALF_EYE_SPAN_FRAC}" ]]; then
    cmd+=(--front-glasses-half-eye-span-frac "${SUPPORT_FRONT_GLASSES_HALF_EYE_SPAN_FRAC}")
  fi
...
ensure_glasses_reference() {
  ...
  if [[ -n "${TASK_GLASSES_LENS_EXPAND_X}" ]]; then
    cmd+=(--lens-expand-x "${TASK_GLASSES_LENS_EXPAND_X}")
  fi
  if [[ -n "${TASK_GLASSES_LENS_EXPAND_Y}" ]]; then
    cmd+=(--lens-expand-y "${TASK_GLASSES_LENS_EXPAND_Y}")
  fi
  if [[ -n "${TASK_GLASSES_MASK_BLUR}" ]]; then
    cmd+=(--mask-blur "${TASK_GLASSES_MASK_BLUR}")
  fi
...
ensure_recolor_reference() {
  ...
  if [[ -n "${RECOLOR_BOX}" ]]; then
    ...
    if [[ -n "${RECOLOR_SOURCE_SUPPLEMENT_BOX:-}" ]]; then
      local combined_mask="${out_dir}/masks/recolor_source_color_mask_combined.png"
      local supplement_command_file="${out_dir}/source_color_supplement_mask_command.txt"
      local supplement_masks=()
      local supplement_boxes=()
      IFS=';' read -r -a supplement_boxes <<< "${RECOLOR_SOURCE_SUPPLEMENT_BOX}"
      : > "${supplement_command_file}"
      for supplement_idx in "${!supplement_boxes[@]}"; do
        local supplement_box="${supplement_boxes[${supplement_idx}]}"
        if [[ -z "${supplement_box}" ]]; then
          continue
        fi
        local supplement_suffix=""
        if [[ "${#supplement_boxes[@]}" -gt 1 ]]; then
          supplement_suffix="_${supplement_idx}"
        fi
        local supplement_mask="${out_dir}/masks/recolor_source_color_supplement${supplement_suffix}_mask.png"
        local supplement_overlay="${out_dir}/masks/recolor_source_color_supplement${supplement_suffix}_overlay.png"
        local supplement_meta="${out_dir}/masks/recolor_source_color_supplement${supplement_suffix}.json"
        local supplement_cmd=(
          "${PYTHON}" "${ROOT}/scripts/make_source_color_mask.py"
          --image "${IMAGE}"
          --output "${supplement_mask}"
          --overlay-output "${supplement_overlay}"
          --metadata-output "${supplement_meta}"
          --source-color "${RECOLOR_SOURCE_COLOR}"
          --box "${supplement_box}"
          --hue-threshold "${RECOLOR_SOURCE_SUPPLEMENT_HUE_THRESHOLD:-${RECOLOR_SOURCE_HUE_THRESHOLD:-0.10}}"
          --lab-threshold "${RECOLOR_SOURCE_SUPPLEMENT_LAB_THRESHOLD:-${RECOLOR_SOURCE_LAB_THRESHOLD:-0.42}}"
          --min-saturation "${RECOLOR_SOURCE_SUPPLEMENT_MIN_SATURATION:-${RECOLOR_SOURCE_MIN_SATURATION:-0.22}}"
          --min-value "${RECOLOR_SOURCE_SUPPLEMENT_MIN_VALUE:-${RECOLOR_SOURCE_MIN_VALUE:-0.18}}"
          --max-value "${RECOLOR_SOURCE_SUPPLEMENT_MAX_VALUE:-${RECOLOR_SOURCE_MAX_VALUE:-0.98}}"
          --mask-threshold "${RECOLOR_SOURCE_SUPPLEMENT_MASK_THRESHOLD:-${RECOLOR_SOURCE_MASK_THRESHOLD:-0.20}}"
          --keep-components "${RECOLOR_SOURCE_SUPPLEMENT_KEEP_COMPONENTS:-1}"
          --min-area "${RECOLOR_SOURCE_SUPPLEMENT_MIN_AREA:-${RECOLOR_SOURCE_MIN_AREA:-80}}"
          --open-kernel "${RECOLOR_SOURCE_SUPPLEMENT_OPEN_KERNEL:-${RECOLOR_SOURCE_OPEN_KERNEL:-1}}"
          --close-kernel "${RECOLOR_SOURCE_SUPPLEMENT_CLOSE_KERNEL:-${RECOLOR_SOURCE_CLOSE_KERNEL:-5}}"
          --dilate-kernel "${RECOLOR_SOURCE_SUPPLEMENT_DILATE_KERNEL:-0}"
          --dilate-iterations "${RECOLOR_SOURCE_SUPPLEMENT_DILATE_ITERATIONS:-0}"
          --dilate-min-saturation "${RECOLOR_SOURCE_SUPPLEMENT_DILATE_MIN_SATURATION:-0.0}"
        )
        if [[ "${RECOLOR_FILL_HOLES:-1}" != "0" ]]; then
          supplement_cmd+=(--fill-holes)
        fi
        printf '%q ' "${supplement_cmd[@]}" >> "${supplement_command_file}"
        printf '\n' >> "${supplement_command_file}"
        echo "[pretty-matrix] generating recolor source-color supplement mask: ${supplement_mask}"
        if [[ "${DRY_RUN}" == "1" ]]; then
          cat "${supplement_command_file}"
        else
          "${supplement_cmd[@]}"
        fi
        supplement_masks+=("${supplement_mask}")
      done
      if [[ "${#supplement_masks[@]}" -gt 0 ]]; then
        local combine_cmd=(
          "${PYTHON}" "${ROOT}/scripts/combine_masks.py"
        ...
        combine_cmd+=("${supplement_masks[@]}")
        printf '%q ' "${combine_cmd[@]}" > "${out_dir}/source_color_combine_mask_command.txt"
        printf '\n' >> "${out_dir}/source_color_combine_mask_command.txt"
        echo "[pretty-matrix] combining recolor source-color masks: ${SUPPORT_MASK}"
        if [[ "${DRY_RUN}" == "1" ]]; then
          cat "${out_dir}/source_color_combine_mask_command.txt"
        else
          "${combine_cmd[@]}"
          mv "${combined_mask}" "${SUPPORT_MASK}"
        fi
      fi
    fi
  fi
  if [[ -n "${TASK_RECOLOR_EXCLUDE_POLYGON:-}" && -n "${SUPPORT_MASK:-}" ]]; then
    local excluded_mask="${out_dir}/masks/recolor_source_color_mask_excluded.png"
    local exclusion_cmd=(
      "${PYTHON}" "${ROOT}/scripts/apply_mask_exclusion.py"
      --input "${SUPPORT_MASK}"
      --output "${excluded_mask}"
      --polygon "${TASK_RECOLOR_EXCLUDE_POLYGON}"
      --feather "${TASK_RECOLOR_EXCLUDE_FEATHER:-0.0}"
      --overlay-image "${IMAGE}"
      --overlay-output "${out_dir}/masks/recolor_source_color_mask_overlay.png"
      --exclusion-output "${out_dir}/masks/recolor_exclusion_mask.png"
    )
    printf '%q ' "${exclusion_cmd[@]}" > "${out_dir}/source_color_exclusion_mask_command.txt"
    printf '\n' >> "${out_dir}/source_color_exclusion_mask_command.txt"
    echo "[pretty-matrix] excluding protected source region from recolor mask: ${SUPPORT_MASK}"
    if [[ "${DRY_RUN}" == "1" ]]; then
      cat "${out_dir}/source_color_exclusion_mask_command.txt"
    else
      "${exclusion_cmd[@]}"
      mv "${excluded_mask}" "${SUPPORT_MASK}"
    fi
  fi
...
apply_recolor_edit_config() {
  ...
  EDIT_COLOR_ARGS=(
    ...
    --edit-color-clean-projection-scale "${RECOLOR_CLEAN_PROJECTION_SCALE:-0.0}"
    --edit-color-clean-projection-mode "${RECOLOR_CLEAN_PROJECTION_MODE:-soft}"
    --edit-color-clean-projection-texture-kernel-size "${RECOLOR_CLEAN_PROJECTION_TEXTURE_KERNEL_SIZE:-7}"
    --edit-color-clean-projection-luma-texture-scale "${RECOLOR_CLEAN_PROJECTION_LUMA_TEXTURE_SCALE:-1.0}"
    --edit-color-clean-projection-chroma-texture-scale "${RECOLOR_CLEAN_PROJECTION_CHROMA_TEXTURE_SCALE:-0.25}"
    --edit-color-clean-projection-delta-lowpass-kernel "${RECOLOR_CLEAN_PROJECTION_DELTA_LOWPASS_KERNEL:-0}"
    --edit-color-clean-projection-alpha-power "${RECOLOR_CLEAN_PROJECTION_ALPHA_POWER:-1.0}"
    --edit-color-clean-projection-boundary-boost "${RECOLOR_CLEAN_PROJECTION_BOUNDARY_BOOST:-0.0}"
    --edit-color-clean-projection-boundary-kernel-size "${RECOLOR_CLEAN_PROJECTION_BOUNDARY_KERNEL_SIZE:-7}"
    --edit-color-clean-projection-composite-mode "${RECOLOR_CLEAN_PROJECTION_COMPOSITE_MODE:-blend}"
    --edit-color-clean-projection-background-kernel-size "${RECOLOR_CLEAN_PROJECTION_BACKGROUND_KERNEL_SIZE:-31}"
...
run_one() {
  ...
  if [[ "${METHOD_ROUTE}" == "full" && "${GENERIC_SUPPORT}" == "1" ]]; then
    ...
    if [[ "${GENERIC_SUPPORT_V3}" == "1" ]]; then
      ...
      SUPPORT_TOP_PERCENTILE="${TASK_SUPPORT_TOP_PERCENTILE:-${SUPPORT_TOP_PERCENTILE}}"
      SUPPORT_MIN_AREA_RATIO="${TASK_SUPPORT_MIN_AREA_RATIO:-${SUPPORT_MIN_AREA_RATIO}}"
      SUPPORT_MAX_AREA_RATIO="${TASK_SUPPORT_MAX_AREA_RATIO:-${SUPPORT_MAX_AREA_RATIO}}"
      SUPPORT_KEEP_COMPONENTS="${TASK_SUPPORT_KEEP_COMPONENTS:-${SUPPORT_KEEP_COMPONENTS}}"
      SUPPORT_DILATE_RADIUS="${TASK_SUPPORT_DILATE_RADIUS:-${SUPPORT_DILATE_RADIUS}}"
      SUPPORT_BLUR_KERNEL="${TASK_SUPPORT_BLUR_KERNEL:-${SUPPORT_BLUR_KERNEL}}"
      ...
      if [[ "${SUPPORT_PRESET}" == "glasses_ref" ]]; then
        ensure_glasses_reference "${out_dir}"
        EDIT_REF_GUIDANCE_SCALE="${TASK_GLASSES_REF_GUIDANCE_SCALE:-0.36}"
        ...
        REF_ARGS=(
          ...
          --edit-ref-structure-image "${IMAGE}"
          --edit-ref-chroma-mode yuv
          --edit-ref-luma-preserve-scale "${TASK_GLASSES_LUMA_PRESERVE:-0.16}"
          --edit-ref-gradient-preserve-scale "${TASK_GLASSES_GRADIENT_PRESERVE:-0.06}"
          --edit-ref-darkness-guard-scale "${TASK_GLASSES_DARKNESS_GUARD:-0.14}"
          --edit-ref-smooth-kernel 1
        )
        if [[ "${TASK_GLASSES_FINAL_REF_COMPOSITE_SCALE:-0.0}" != "0.0" ]]; then
          REF_ARGS+=(
            --final-ref-composite-image "${GLASSES_REF_IMAGE}"
            --final-ref-composite-mask "${GLASSES_MASK}"
            --final-ref-composite-scale "${TASK_GLASSES_FINAL_REF_COMPOSITE_SCALE}"
            --final-ref-composite-mask-blur "${TASK_GLASSES_FINAL_REF_COMPOSITE_BLUR:-0.8}"
          )
        fi
      fi
      if [[ "${SUPPORT_PRESET}" == "surface_strip" ]]; then
    ...
    case "${TASK_KIND}" in
      ...
      accessory_semantic_glasses)
        ...
        ensure_semantic_mask "${out_dir}"
        ensure_glasses_reference "${out_dir}"
        EDIT_HEDIT_GUIDANCE_SCALE="${TASK_GLASSES_HEDIT:-0.62}"
        EDIT_TEXT_GUIDANCE_SCALE="${TASK_GLASSES_TEXT:-0.04}"
        EDIT_REF_GUIDANCE_SCALE="${TASK_GLASSES_REF_GUIDANCE_SCALE:-0.46}"
        TRAJECTORY_PRESERVE_SCALE="${TASK_GLASSES_TRAJ:-0.18}"
        REC_GUIDANCE_SCALE="${TASK_GLASSES_REC:-0.0}"
        FINAL_MASK_ARGS=(--final-edit-mask "${GLASSES_MASK}" --final-edit-mask-mode replace)
        REF_ARGS=(
          --edit-ref-image "${GLASSES_REF_IMAGE}"
          --edit-ref-mask "${GLASSES_MASK}"
          --edit-ref-structure-image "${IMAGE}"
          --edit-ref-chroma-mode yuv
          --edit-ref-luma-preserve-scale "${TASK_GLASSES_LUMA_PRESERVE:-0.12}"
          --edit-ref-gradient-preserve-scale "${TASK_GLASSES_GRADIENT_PRESERVE:-0.04}"
          --edit-ref-darkness-guard-scale "${TASK_GLASSES_DARKNESS_GUARD:-0.18}"
          --edit-ref-smooth-kernel 1
        )
        ;;
      decal)
  ...
  if [[ -n "${TASK_LOCAL_TARGET_GUIDANCE_SCALE}" && -n "${SUPPORT_LOCAL_TARGET_PROMPT}" ]]; then
    EDIT_LOCAL_TARGET_PROMPT="${SUPPORT_LOCAL_TARGET_PROMPT}"
    EDIT_LOCAL_TARGET_GUIDANCE_SCALE="${TASK_LOCAL_TARGET_GUIDANCE_SCALE}"
    EDIT_LOCAL_TARGET_CFG_SCALE="${TASK_LOCAL_TARGET_CFG_SCALE:-${EDIT_LOCAL_TARGET_CFG_SCALE}}"
  fi
  ...
  if [[ -n "${TASK_EDIT_MASK_BOX}" ]]; then
    cmd+=(--edit-mask-box "${TASK_EDIT_MASK_BOX}" --edit-mask-box-mode "${TASK_EDIT_MASK_BOX_MODE:-replace}")
  fi
  if [[ "${LOW_VRAM}" == "1" ]]; then
    cmd+=(--low-vram)
  fi
