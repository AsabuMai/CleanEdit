...
#SBATCH -J t5-pill-s1012
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/t5_pillow_replacements_seeds10_12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/t5_pillow_replacements_seeds10_12_%j.err
...
echo "== T5 pillow replacements: seeds 10,11,12 =="
TASKS="pillow_white_chair_cable_knit pillow_white_sofa_cluster_cable_knit" \
...
tasks = "pillow_white_chair_cable_knit pillow_white_sofa_cluster_cable_knit".split()
