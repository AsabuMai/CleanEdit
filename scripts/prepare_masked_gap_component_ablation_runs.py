...
METHODS = {
    ...
    "sd3_wopreserve": (
        ...
        "support_v3_controller_rmsgap",
        "SD3 w/o source-anchor residual",
    ),
    "sd3_maskedgap": (
        PROJ / "outputs/final_component_ablation_non_t4_sd3_maskedgap",
        "support_v3_controller_rmsgap",
        "SD3 masked gap only",
    ),
    "sd3_wofeedback": (
        ...
        "support_v3_controller_rmsgap",
        "SD3 w/o trajectory feedback",
    ),
    "sd3_woopsupport": (
        PROJ / "outputs/final_component_ablation_non_t4_sd3_opsupport",
        "support_v3_controller_rmsgap",
        "SD3 w/o operation-specific support",
    ),
    "full_flux": (
    ...
    "flux_wopreserve": (
        ...
        "dece_rf_flux",
        "FLUX w/o source-anchor residual",
    ),
    "flux_maskedgap": (
        PROJ / "outputs/final_component_ablation_non_t4_flux_maskedgap",
        "dece_rf_flux",
        "FLUX masked gap only",
    ),
    "flux_wofeedback": (
        PROJ / "outputs/final_component_ablation_non_t4_flux_adaptive",
        "dece_rf_flux",
        "FLUX w/o trajectory feedback",
    ),
    "flux_woopsupport": (
        PROJ / "outputs/final_component_ablation_non_t4_flux_opsupport",
        "dece_rf_flux",
        "FLUX w/o operation-specific support",
    ),
}
